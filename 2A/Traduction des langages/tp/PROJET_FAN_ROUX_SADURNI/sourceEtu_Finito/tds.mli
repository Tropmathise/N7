...
type info =
  ...
  (* Information associée à une enumeration : son nom, et la liste des énumérations *)
  | InfoEnum of string * (string list)
  (* Information associée à une valeur d'enumeration : le nom du type énumération, et la valeur, son adresse et son registre *)
...
(* Ajouter les parametres à la liste *)
val ajouter_lt_info : typ list -> info_ast -> unit
...
(* merge3 : 'a list * 'b list * 'c list -> ('a * 'b * 'c) list *)
val merge3 : 'a list * 'b list * 'c list -> ('a * 'b * 'c) list
