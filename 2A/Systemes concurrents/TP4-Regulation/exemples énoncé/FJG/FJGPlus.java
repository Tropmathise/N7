...
class TraiterProblèmePLUS extends RecursiveTask<Integer> {

    private int resteAFaire = 0;
    private int résultat = 0;
    static final int SEUIL = 10;

    TraiterProblèmePLUS(int resteAFaire) {
    ...
    protected Integer compute() {
        ...
        if(this.resteAFaire > SEUIL) {
            ...
            TraiterProblèmePLUS sp1 = new TraiterProblèmePLUS(this.resteAFaire / 2);
            TraiterProblèmePLUS sp2 = new TraiterProblèmePLUS(this.resteAFaire / 2);
...
public class FJGPlus {
    ...
    public static void main(String[] args) throws Exception {
        long fin,départ;
        TraiterProblèmePLUS monProblème = new TraiterProblèmePLUS(TAILLE);
