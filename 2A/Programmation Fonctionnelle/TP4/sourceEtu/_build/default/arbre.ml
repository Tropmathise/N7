...
(******************************************************************************)
(*   fonction retrait d'une liste éléments dans un arbre                      *)
...
let rec retrait_arbre lc (Noeud(b, lb)) =
    if appartient_arbre lc (Noeud(b, lb)) then 
      match lc with 
      | [] -> Noeud (false, [])
      | c::qlc -> let arbre_c = 
                    let l = (recherche c lb) in 
    ...
    (**************************************************************************)
(*   fonction retrait d'une branche inutile dans un arbre                     *)
(*   signature  : normalisation : 'a arbre -> 'a arbre                        *)
(*   paramètres : - un arbre n-aire                                           *)
(*   résultat   : l'arbre n-aire normalisé                                    *)
(******************************************************************************)
