...
;;
    (************************************************************************************)
(*   fonction de retrait d'un élément d'un trie                                         *)
(*   signature  : trie_retrait_normalisé : 'a -> ('a, 'b) trie -> ('a, 'b) trie = <fun> *)
(*   paramètres : - un mot                                                              *)
(*                - un trie                                                             *)
(*   résultat   : le trie avec le mot retiré et la branche inutile supprimé             *)
(******************************************************************************)
...
let affiche p (Trie(arbre, decompose, recompose)) = 
    List.iter (fun mot -> p (recompose mot)) (trie_dico (Trie(arbre, decompose, recompose)))
