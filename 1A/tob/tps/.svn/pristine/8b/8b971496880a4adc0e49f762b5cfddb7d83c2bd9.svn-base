...
public class ExempleSchema1 {
	...
	public static void main(String[] args)
	{
		...
		Ecran exempleSchema1 = new Ecran("ExempleSchema1", 600, 400, 20);
		p1.dessiner(exempleSchema1);
		p2.dessiner(exempleSchema1);
		p3.dessiner(exempleSchema1);
		s12.dessiner(exempleSchema1);
		s23.dessiner(exempleSchema1);
		s31.dessiner(exempleSchema1);
		barycentre.dessiner(exempleSchema1);
		exempleSchema1.dessinerAxes();
		...
		AfficheurSVG test = new AfficheurSVG("SVG", "description", 600, 400);

		p1.dessinerSVG(test);
		p2.dessinerSVG(test);
		p3.dessinerSVG(test);
		s12.dessinerSVG(test);
		s23.dessinerSVG(test);
		s31.dessinerSVG(test);
		barycentre.dessinerSVG(test);
		test.ecrire("schema.svg");
