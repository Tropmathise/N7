...
void add(string *chaine_dest, char c){
    // ****** TODO *******
    char* nv_chaine_dest_str=realloc(chaine_dest->str,(strlen(chaine_dest->str)+1)*sizeof(char));
    if (nv_chaine_dest_str){
        chaine_dest->str=nv_chaine_dest_str;
    }
    strncat(nv_chaine_dest_str,&c,1);
    chaine_dest->str=nv_chaine_dest_str;
...
void delete(string *chaine_dest, int i){
    // ****** TODO *******
    char* nv_chaine_dest_str=realloc(chaine_dest->str,(strlen(chaine_dest->str))*sizeof(char));
    if (nv_chaine_dest_str){
        chaine_dest->str=nv_chaine_dest_str;
    }
    memmove(&nv_chaine_dest_str[i],&nv_chaine_dest_str[i+1],strlen(nv_chaine_dest_str)-i);
    chaine_dest->str=nv_chaine_dest_str;
    chaine_dest->N=chaine_dest->N-1;
}
