...
figure(4),clf
plot(0,0,'ko','linewidth',2)
hold on,plot([0 1.1],[0 0],'k-') % tracer le segment de droite permettant de 
...
legend('origine du repere','individus','element moyen');
title('des nombres sur un plan des reels');
...
hold on 
plot3(x(1,:),x(2,:),x(3,:),'r*', x_mean(1),x_mean(2),x_mean(3),'b+', 'linewidth',3);
grid on 
legend('origine du repere','individus','element moyen');
title('Nombres générés aléatoirement suivant une distribution gaussienne de moyenne 2 et d écart type 3')
