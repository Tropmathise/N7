...
!-------------------------------------------------------------------------------------------------------------------
  subroutine subspace_iter_v3(n, m, a, p, percentage, maxit, eps, v, w, n_ev, acc_ev, it_ev, ierr)
    ...
    double precision, dimension(n,n) :: aux, ap
    integer :: nc
    ...
    do while((eig_sum .lt. p_trace) .and. (n_ev .lt. m) .and. (k .lt. maxit))
      ...
      do i=1, p
        call dgemm('n','n',n,m-nc,n,done,a,n,v(1,nc+1),n,dzero,y(1,nc+1),n)
        v(:,nc+1:m)=y(:,nc+1:m)
      end do
      ...
      call gram_schmidt_block(y, n, m,nc, v)
      ...
      call dgemm('n','n', n, m-nc, n, done, a, n, v(1,nc+1), n, dzero, y(1,nc+1), n)
      !!     H = V'*Y
      call dgemm('t', 'n', m-nc, m, n, done, v(1,nc+1), n, y(1,nc+1), n, dzero, h, m) 
      !!   2. Spectral decomposition
      call dsyev('v', 'u', m-nc, h, m, w_aux, work, lwork, ierr)    
